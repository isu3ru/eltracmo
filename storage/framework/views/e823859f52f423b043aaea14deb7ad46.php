...
<?php $__env->startSection('script'); ?>
    <!-- Chart JS -->
    <script src="<?php echo e(URL::asset('assets/libs/chart.js/Chart.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/assets/js/pages/chartjs.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\Skote_Laravel\admin\resources\views/charts-chartjs.blade.php ENDPATH**/ ?>