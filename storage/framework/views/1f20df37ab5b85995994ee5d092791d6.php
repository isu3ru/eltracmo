...
<!-- Session timeout js -->
<script src="<?php echo e(URL::asset('assets/libs/@curiosityx/bootstrap-session-timeout/index.js')); ?>"></script>

<!-- Session timeout js -->
<script src="<?php echo e(URL::asset('/assets/js/pages/session-timeout.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\Skote_Laravel\admin\resources\views/ui-session-timeout.blade.php ENDPATH**/ ?>