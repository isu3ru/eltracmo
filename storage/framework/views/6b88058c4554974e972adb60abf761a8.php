...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="tel" name="contact_person_telephone" id="contact_person_telephone"
                                class="form-control <?php $__errorArgs = ['contact_person_telephone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required
                                value="<?php echo e(old('contact_person_telephone')); ?>">
                            <?php $__errorArgs = ['contact_person_telephone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="email" name="contact_person_email" id="contact_person_email"
                                class="form-control <?php $__errorArgs = ['contact_person_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\eltracmo\resources\views/suppliers/index.blade.php ENDPATH**/ ?>