...
<?php $__env->startSection('css'); ?>
    <!-- ION Slider -->
    <link href="<?php echo e(URL::asset('assets/libs/ion-rangeslider/css/ion.rangeSlider.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<?php $__env->startSection('script'); ?>
    <!-- Ion Range Slider-->
    <script src="<?php echo e(URL::asset('assets/libs/ion-rangeslider/js/ion.rangeSlider.min.js')); ?>"></script>

    <!-- init js -->
    <script src="<?php echo e(URL::asset('/assets/js/pages/product-filter-range.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\Skote_Laravel\admin\resources\views/ecommerce-products.blade.php ENDPATH**/ ?>