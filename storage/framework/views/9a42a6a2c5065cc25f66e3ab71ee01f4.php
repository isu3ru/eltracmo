        ...
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="<?php echo e(URL::asset('assets/images/companies/adobe-photoshop.svg')); ?>" alt="" height="50" class="mx-auto d-block">
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body border-bottom">
                <div class="d-flex">
                    <img src="<?php echo e(URL::asset('assets/images/companies/wechat.svg')); ?>" alt="" height="50">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\Skote_Laravel\admin\resources\views/job-details.blade.php ENDPATH**/ ?>