...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Job_Grid'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('css'); ?>
<link href="<?php echo e(URL::asset('assets/libs/bootstrap-datepicker/css/bootstrap-datepicker.min.css')); ?>" rel="stylesheet" type="text/css">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>

<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Jobs <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Jobs Grid <?php $__env->endSlot(); ?>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/adobe.svg')); ?>" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/adobe-photoshop.svg')); ?>" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/airbnb.svg')); ?>" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/amazon.svg')); ?>" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/flutter.svg')); ?>" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/mailchimp.svg')); ?>" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/line.svg')); ?>" alt="" height="50" class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/spotify.svg')); ?>" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/wordpress.svg')); ?>" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/upwork.svg')); ?>" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/sass.svg')); ?>" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/reddit.svg')); ?>" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
...
<script src="<?php echo e(URL::asset('assets/libs/bootstrap-datepicker/js/bootstrap-datepicker.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\Skote_Laravel\admin\resources\views/job-grid.blade.php ENDPATH**/ ?>