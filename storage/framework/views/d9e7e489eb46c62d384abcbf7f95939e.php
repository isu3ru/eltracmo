        ...
        <div class="card mx-n4 mt-n4 bg-info bg-soft">
            <div class="card-body">
                <div class="text-center mb-4">
                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>" alt="" class="avatar-md rounded-circle mx-auto d-block" />
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\Skote_Laravel\admin\resources\views/candidate-overview.blade.php ENDPATH**/ ?>