    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card border border-warning">
                <div class="card-header bg-warning text-white">Update user</div>
                <div class="card-body">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userD): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e($userD->mobile_number); ?></td>
                                    <td><?php echo e($userD->email); ?></td>
                                    <td>
                                        <a href="<?php echo e(route('users.update', $userD->id)); ?>"
                                            class="btn btn-sm btn-primary">Edit</a>
                                        <form action="<?php echo e(route('users.delete', $userD->id)); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\eltracmo\resources\views/users/edit.blade.php ENDPATH**/ ?>