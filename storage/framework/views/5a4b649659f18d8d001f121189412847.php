...
<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/assets/libs/toastr/build/toastr.min.css')); ?>">
...
<!-- toastr plugin -->
<script src="<?php echo e(URL::asset('assets/libs/toastr/build/toastr.min.js')); ?>"></script>

<!-- toastr init -->
<script src="<?php echo e(URL::asset('/assets/js/pages/toastr.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\Skote_Laravel\admin\resources\views/ui-notifications.blade.php ENDPATH**/ ?>