...
<!-- Magnific Popup-->
<script src="<?php echo e(URL::asset('assets/libs/magnific-popup/jquery.magnific-popup.min.js')); ?>"></script>

<!-- lightbox init js-->
<script src="<?php echo e(URL::asset('/assets/js/pages/lightbox.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\Skote_Laravel\admin\resources\views/ui-lightbox.blade.php ENDPATH**/ ?>