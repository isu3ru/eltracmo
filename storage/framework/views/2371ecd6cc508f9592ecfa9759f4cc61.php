...
<?php $__env->startSection('script'); ?>
    <!-- form mask -->
    <script src="<?php echo e(URL::asset('assets/libs/inputmask/min/jquery.inputmask.bundle.min.js')); ?>"></script>

    <!-- form mask init -->
    <script src="<?php echo e(URL::asset('/assets/js/pages/form-mask.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\Skote_Laravel\admin\resources\views/form-mask.blade.php ENDPATH**/ ?>